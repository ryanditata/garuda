...
class ApplywithFilterExport implements FromQuery, WithHeadings, WithMapping, WithStyles, ShouldAutoSize
{
    ...
    {
        $query = Apply::query()->with('status', 'document');
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        // No = A, Department = D, Nationality = E
