    ...
    <div class="flex flex-wrap md:min-h-screen md:flex-nowrap">
        ...
        <div @click.away="open = false"
            ...
            <div class="flex-shrink-0 px-8 py-4 flex flex-row items-center justify-between">
                <a href="#"
                    class="text-lg font-semibold text-gray-900 rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">
                    <img src="{{ asset('assets/logo-udinus.png') }}" alt="UDINUS Logo"
                        class="h-10 w-10 md:h-20 md:w-20 mr-2">
                    <span
                        class="text-lg font-semibold text-gray-900 rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline hidden md:flex">Garuda
                        Scholarship</span>
                </a>
            ...
            <nav :class="{ 'block': open, 'hidden': !open }"
                ...
                <a class="flex items-center px-4 py-2 mt-2 text-sm font-semibold text-gray-900 bg-transparent rounded-lg dark-mode:bg-gray-700 dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 focus:text-gray-900 hover:bg-blue-700 hover:text-white focus:bg-gray-200 focus:outline-none focus:shadow-outline {{ request()->is('/home') ? 'bg-blue-700 text-black' : '' }}"
                    href="/home">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="currentColor" class="bi bi-house"
                        viewBox="0 0 16 16">
                        <path
                ...
                <a class="flex items-center px-4 py-2 mt-2 text-sm font-semibold text-gray-900 bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 hover:bg-blue-700 hover:text-white focus:text-gray-900 focus:bg-gray-200 focus:outline-none focus:shadow-outline {{ request()->is('/apply') ? 'bg-blue-700 text-black' : '' }}"
                    href="/apply">
                ...
                <a class="flex items-center px-4 py-2 mt-2 text-sm font-semibold text-gray-900 bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 hover:bg-blue-700 hover:text-white focus:text-gray-900 focus:bg-gray-200 focus:outline-none focus:shadow-outline {{ request()->is('/profile') ? 'bg-blue-700 text-black' : '' }}"
                    href="/profile">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="currentColor"
                ...
                <form method="POST" action="{{ route('logout') }}" class="w-full">
                    @csrf
                    <button type="submit"
                        class="flex items-center w-full px-4 py-2 mt-2 text-sm font-semibold text-gray-900 bg-transparent rounded-lg hover:bg-blue-700 hover:text-white focus:bg-gray-200 focus:outline-none focus:shadow-outline">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="currentColor"
        ...
        <div class="flex flex-col w-full">
            <nav
                class="bg-[#003d7a] mb-3 hidden md:flex shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)]">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex">
                            <div class="text-white">
                                <p href="#" class="font-semibold text-sm">Hello {{ Auth::user()->email }}</a>
                            </div>
                        </div>
                    </div>
                </div>
