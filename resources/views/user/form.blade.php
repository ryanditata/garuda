                    ...
                    <div class="w-full h-full lg:w-full bg-white p-8 rounded-xl mx-3">
                        ...
                        <div class="flex justify-center">
                            <a href="{{ route('user.index') }}"
                                class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded-md mt-3">Back</a>
                        </div>
                    </div>
                @else
                    <div class="w-full lg:w-full bg-white p-8 rounded-xl mx-3">
                        <h3 class="text-2xl font-bold text-center">Register</h3>
                        <form id="app-form" action="{{ route('user.submitApplication') }}" method="POST"
                            enctype="multipart/form-data" class="mt-8">
                            @csrf
                            <div class="flex flex-wrap mb-4">
                                <div class="w-full px-3 xl:w-1/2">
                                    <label for="first_name" class="text-sm font-bold text-gray-600">First Name<span
                                            class="text-red-500">*</span></label>
                                    <input type="text" name="first_name" id="first_name"
                                        class="border border-gray-300 p-2 rounded-md mt-1 w-full" placeholder="john"
                                ...
                                <div class="w-full px-3 xl:w-1/2">
                                    <label for="family_name" class="text-sm font-bold text-gray-600">Family Name<span
                                            class="text-red-500">*</span></label>
                                    <input type="text" name="family_name" id="family_name"
                                        class="border border-gray-300 p-2 rounded-md mt-1 w-full" placeholder="doe"
                            ...
                            <div class="flex flex-wrap mb-4">
                                <div class="w-full px-3 xl:w-1/2">
                                    <label for="email" class="text-sm font-bold text-gray-600">Email<span
                                            class="text-red-500">*</span></label>
                            ...
                            <div class="flex flex-wrap mb-4">
                                <div class="w-full px-3 xl:w-1/4">
                                    <label for="nationality" class="text-sm font-bold text-gray-600">Nationality<span
                                            class="text-red-500">*</span></label>
                            ...
                            <div class="flex flex-wrap mb-4 px-3">
                                <p class="text-red-500">*<span class="text-xs text-gray-500 mt-2">Note: JPG, JPEG, and PNG
                                        are allowed.</span>
                                <p>
                            </div>
                            <div class="flex flex-wrap mb-4">
                            ...
                            <div class="flex flex-wrap mb-4 px-3">
                                <p class="text-red-500">*<span class="text-xs text-gray-500 mt-2">Note: Only PDF is
                                        allowed.</span>
                                <p>
                            </div>
                            <div class="flex flex-wrap mb-4">
                                <div class="w-full px-3 xl:w-1/3">
                                    <label for="passport" class="text-sm font-bold text-gray-600">Passport<span
                                            class="text-red-500">*</span></label>
                                ...
                                <div class="w-full px-3 xl:w-1/3">
                                    <label for="medical_checkup" class="text-sm font-bold text-gray-600">Medical
                                        Checkup<span class="text-red-500">*</span></label>
                                ...
                                <div class="w-full px-3 xl:w-1/3">
                                    <label for="study_plan" class="text-sm font-bold text-gray-600">Study Plan<span
                                            class="text-red-500">*</span></label>
                            ...
                            <div class="flex flex-wrap mb-4">
                                <div class="w-full px-3 xl:w-1/3">
                                    <label for="english_proficiency" class="text-sm font-bold text-gray-600">English
                                        Proficiency<span class="text-red-500">*</span></label>
                                ...
                                <div class="w-full px-3 xl:w-1/3">
                                    <label for="cv" class="text-sm font-bold text-gray-600">Curriculum Vitae<span
                                            class="text-red-500">*</span></label>
                            ...
                            <div class="flex flex-wrap mb-4">
                                <div class="w-full px-3 xl:w-1/3">
                                    <label for="first_letter_of_recommendation"
                                        class="text-sm font-bold text-gray-600">First Letter Recommendation<span
                                            class="text-red-500">*</span></label>
                                ...
                                <div class="w-full px-3 xl:w-1/3 hidden" id="block_research_proposal">
                                    <label for="research_proposal" class="text-sm font-bold text-gray-600">Research
                                        Proposal<span class="text-red-500">*</span></label>
                            ...
                            <div class="flex flex-wrap mb-4">
                                <div class="w-full px-3">
                                    <button type="button" id="registerButton" onclick="submitButton(event)"
